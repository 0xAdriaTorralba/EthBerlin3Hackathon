...
Fr_leq(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 1]); // line circom 13
...
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + 5],&circuitConstants[0]); // line circom 17
